...
def delete_group(group_name):
    ...
    if Ret.returncode == 0:
        ...
        if Ret.returncode == 0:
            ...
            logger.error("delete vg %s failed" % group_name)
            return False
    else:
...
def delete_volume(group_name, volume_name):
    ...
    if Ret.returncode == 0:
        ...
        if Ret.returncode == 0:
            ...
            logger.error("delete lv %s in vg %s failed" % (volume_name,group_name))
            return False
    else:
